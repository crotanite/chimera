...
export default {
    config: {
        classes: generateClasses({
            ...
            global: {
                fieldset: 'max-w-md border border-gray-400 px-2 pb-1 dark:border-gray-700',
                help: 'text-xs text-gray-500',
                inner: 'border formkit-disabled:bg-gray-200 formkit-disabled:cursor-not-allowed formkit-disabled:pointer-events-none bg-white dark:bg-gray-900 dark:border-gray-700 text-sm dark:formkit-disabled:bg-gray-700 formkit-disabled:cursor-not-allowed dark:text-gray-100',
                input: 'appearance-none h-[38px] bg-transparent focus:outline-none focus:shadow-none',
            ...
            'family:box': {
                decorator: 'block relative h-5 w-5 mr-2 bg-white text-transparent peer-checked:bg-primary-500 peer-checked:text-white border rounded overflow-hidden cursor-pointer dark:border-gray-700 dark:peer-checked:bg-primary-600',
                ...
                label: '$reset font-bold text-sm select-none',
            ...
            'family:dropdown': {
                dropdownWrapper: 'w-full drop-shadow-lg [&::-webkit-scrollbar]:hidden',
                emptyMessageInner: 'flex items-center justify-center text-sm p-2 text-center w-full text-gray-500 [&>span]:mr-3 [&>span]:ml-0',
                inner: 'max-w-md relative flex [&>span:first-child]:focus-within:text-primary-500',
                input: 'px-3 py-2',
                listbox: 'bg-white drop-shadow-lg overflow-hidden dark:bg-gray-900',
                listboxButton: 'flex w-12 self-stretch justify-center mx-auto',
                listitem: 'pl-4 relative hover:bg-gray-200 data-[is-active="true"]:bg-gray-200 data-[is-active="true"]:aria-selected:bg-primary-600 aria-selected:bg-primary-600 aria-selected:text-white dark:hover:bg-gray-700 cursor-pointer dark:data-[is-active="true"]:bg-gray-700',
                loaderIcon: 'ml-auto',
            ...
            'family:text': {
                inner: 'flex items-center [&>label:first-child]:focus-within:text-primary-500',
                input: 'w-full px-3 py-2 border-none placeholder-gray-400',
            },
            ...
            color: {
                ...
                input: '$reset appearance-none w-full cursor-pointer border-none p-0 m-0 bg-transparent [&::-webkit-color-swatch-wrapper]:p-0 [&::-webkit-color-swatch]:border-none',
            ...
            select: {
                inner: 'flex relative items-center [&>span:first-child]:focus-within:text-primary-500',
                input: 'w-full pl-3 pr-8 py-2 border-none placeholder-gray-400 formkit-multiple:p-0 data-[placeholder="true"]:text-gray-400 formkit-multiple:data-[placeholder="true"]:text-inherit',
                selectIcon: 'flex p-[3px] shrink-0 w-5 mr-2 -ml-[1.5em] h-full pointer-events-none',
                option: 'formkit-multiple:p-3 formkit-multiple:text-sm text-gray-700'
            },
            textarea: {
                inner: 'flex mb-1 [&>label:first-child]:focus-within:text-primary-500',
                input: 'block w-full h-24 px-3 py-3 border-none placeholder-gray-400 focus:shadow-outline',
            },
            ...
            autocomplete: {
                ...
                selection: 'static flex left-0 top-0 right-0 bottom-0 mt-0 mb-2 bg-white dark:bg-gray-900 items-center',
            },
            rating: {
            ...
            taglist: {
                ...
                tag: 'flex items-center p-1 bg-gray-200 text-xs rounded-full dark:bg-gray-700',
